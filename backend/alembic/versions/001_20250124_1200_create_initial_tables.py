...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_atm_telemetry_error_code"), "atm_telemetry", ["error_code"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "target_atms", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
    ...
    op.create_index(
        "idx_alert_rule_active_severity", "alert_rules", ["is_active", "severity"]
    )
    ...
    op.create_index(
        "idx_maintenance_atm_date", "maintenance_records", ["atm_id", "scheduled_date"]
    )
    op.create_index(
        "idx_maintenance_status_date",
        "maintenance_records",
        ["status", "scheduled_date"],
    )
    op.create_index(
        op.f("ix_maintenance_records_maintenance_type"),
        "maintenance_records",
        ["maintenance_type"],
    )
    op.create_index(
        op.f("ix_maintenance_records_status"), "maintenance_records", ["status"]
    )
